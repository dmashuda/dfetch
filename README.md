...
connectors, and every piece is swappable — connectors, typed-source registry,
config, credentials, and the SQLite layer.

See **[library.md](library.md)** for the full guide: embedding the engine,
registering your own connectors, building config in code, plugging in a secret
store, and custom SQLite management.
